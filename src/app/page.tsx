      ...
      <main className="flex flex-col items-center overflow-x-hidden">
        ...
        <section className="mt-[100px] flex flex-col items-center justify-center md:flex md:justify-start md:items-start lg:self-start md:pl-[70px]">
          ...
          <div className="flex gap-[38px] mt-[70px] px-4 lg:px-0 md:flex-wrap">
            ...
            <CardArrival
              link="/shop/men"
              imageSrc="/assets/full_sleeve.png"
              name="Full Sleeve"
            />
            <CardArrival
              link="/shop/men"
              imageSrc="/assets/active_tshirt.png"
              name="Active T-Shirts"
            />
            <CardArrival
              link="/shop/women"
              imageSrc="/assets/urban_shirt.png"
              name="Urban Shirts"
            />
          </div>
        </section>
          ...
          <div className="flex flex-wrap gap-[20px] mt-[70px] items-center justify-center">
            <div className="relative text-white">
              ...
              <div className="absolute hidden lg:flex flex-col top-16 left-[20px]">
                ...
                <p className="font-semibold text-sm">Dress up in summer vibe</p>
                ...
                <Link
                  href={"/shop/men"}
                  className="rounded-[4px] text-xs py-[10px] px-[25px] border border-white bg-transparent"
                >
                  SHOP NOW
                </Link>
              </div>
            ...
            <div className="relative text-white ">
              ...
              <div className="lg:flex flex-col absolute hidden top-4 right-[26px] lg:max-w-[160px] ">
                <Link
                  href="/women"
                  className="hover:opacity-80 transition-opacity text-white bg-gray-text-menu mb-[26px] px-[16px] py-[10px] self-end rounded-[4px]"
                >
                  Limited Stock
                </Link>
                ...
                <Link
                  href={"/women"}
                  className="hover:opacity-80 text-xs transition-opacity text-center rounded-[4px] py-[10px] px-[25px] border border-white bg-transparent"
                >
                  SHOP NOW
                </Link>
              </div>
            ...
            <div className="relative text-gray-text-menu">
              ...
              <div className="lg:flex flex-col items-start absolute hidden top-16 right-[17px] lg:max-w-[156px] ">
                ...
                <Link
                  href={"/women"}
                  className="hover:opacity-80 text-xstransition-opacity text-center rounded-[4px] py-[10px] px-[25px] border border-gray-text-menu bg-transparent"
                >
                  SHOP NOW
                </Link>
              </div>
            ...
            <div className="relative text-gray-text-menu">
              ...
              <div className="lg:flex flex-col items-start absolute hidden top-[45px] right-[120px] lg:max-w-[133px] ">
                ...
                <Link
                  href={"/shop/men"}
                  className="hover:opacity-80 text-xs transition-opacity text-center rounded-[4px] w-full py-[11px]  border-2 border-gray-text-menu bg-transparent"
                >
                  SHOP NOW
                </Link>
              </div>
