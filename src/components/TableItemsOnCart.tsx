    ...
    MySwal.fire({
      ...
      if (result.isConfirmed) {
        ...
        const itemsFiltered = itemsStorage.filter(
          (currentItem) =>
            currentItem.color !== item.color || currentItem.size !== item.size
        );
    ...
    <>
      {itemsStorage?.length >= 1 ? (
              ...
              <tr key={uuidv4()} className="text-center">
                ...
                <td className="min-w-[100px]">
                  <div className="flex justify-center items-center gap-3 h-[36px] min-w-[100px] rounded-xl bg-white-light w-full  text-gray-text-menu font-medium">
                    <button
                      className="px-2 disabled:cursor-not-allowed disabled:opacity-70"
        ...
        <div className="flex flex-col gap-7 items-center justify-center mb-12">
          ...
          <h2 className="font-semibold font-coreSans mb-3 text-4xl">
            Your cart is empty and sad :(
          </h2>
          <p className="text-gray-light font-coreSans">
